...
#ifndef KUKA_EKI_MOTION_PRIMITIVES_HW_INTERFACE__VISIBILITY_CONTROL_H_
#define KUKA_EKI_MOTION_PRIMITIVES_HW_INTERFACE__VISIBILITY_CONTROL_H_
...
#endif  // KUKA_EKI_MOTION_PRIMITIVES_HW_INTERFACE__VISIBILITY_CONTROL_H_
